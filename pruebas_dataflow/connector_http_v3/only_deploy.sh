...
export TEMPLATE_IMAGE="gcr.io/$PROJECT/http_connector_v3/streaming:latest"

export DATASET="dataflow_tests"
export TABLE="http_connector_v3"
export TOPIC="http_connector_v3"


export TEMPLATE_PATH="gs://$BUCKET/http_connector_v3/streaming.json"
export REGION="us-east1"
#export REGION="us-west1"

# Run the Flex Template.
gcloud dataflow flex-template run "http-connector-v3" \
